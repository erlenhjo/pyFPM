...
def plot_BFL_step_experiments(raw_result_folders: List[Path],
    ...
    for calibration_results_per_step, optimization_results_per_step \
        ...
        optimization_score_filter_value = 1.7 * np.median(np.array(optimization_score_vals_per_dataset))
...
def plot_BFL_step_experiments_combined(raw_result_folders: List[Path],
    ...
    for NA_times_z_0_vals, distance_ratio_vals, delta_x_vals, delta_y_vals, rotation_vals, optimization_score_vals in \
        zip(NA_times_z_0_vals_per_dataset, distance_ratio_vals_per_dataset, delta_x_vals_per_dataset, 
    ...
    axes[0].set_ylabel("Optimization score [unitless]")
    ...
    axes[1].set_ylabel("Optimization score [unitless]")
