...
from pyFPM.recovery.calibration.multi_non_linear_BFL import multi_non_linear_BFL
...
def locate_bright_field_from_setup_multi(datadirpaths, relative_LED_distances, 
    ...
    start = time.perf_counter()
    calibration_parameters = multi_non_linear_BFL(data_patches = data_patches, setup_parameters = setup_parameters,
                                                  assumed_calibration_parameters = assumed_calibration_parameters,
