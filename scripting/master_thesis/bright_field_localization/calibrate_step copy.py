...
def main():
    ...
    multi_step_tele_3x_2(calibrate=calibrate, plot=plot)
...
def multi_step_tele_3x(calibrate, plot):
    lens = TELECENTRIC_3X
    camera = IDS_U3_31J0CP_REV_2_2
    experiment_name = "3xtele_illum_step_2mm_2xbin"
    dataset_names = [
...
def multi_step_tele_3x_2(calibrate, plot):
    lens = TELECENTRIC_3X
    camera = IDS_U3_31J0CP_REV_2_2
    experiment_name = "3xtele_illum_step_4mm_2xbin"
    dataset_names = [
